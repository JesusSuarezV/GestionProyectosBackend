...
public class ProyectoControlador {
	...
	public String listarProyectos(Model model) {
		...
		return "Proyectos/Ver_Proyectos"; //URL en donde retorna el metodo
	}
	...
	public String mostrarFormularioDeRegistrarProyectos(Model modelo) {
		...
		return "/Proyectos/Crear_Proyecto"; //URL en donde retorna el metodo
	...
	public String guardarCategoria(@RequestParam("nombre") String nombre){
		...
		Proyecto proyecto = new Proyecto(id, nombre, true); //se crea el proyecto
	...
	public String actualizarProyecto(@PathVariable int id, @RequestParam("nombre") String nombre){
